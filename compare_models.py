...
def orig_adv_dist(orig_img = None, target_img = None, plot = False, bestC = None, iteration = 1):
    ...
    best_noise, best_orig_dist, best_adv_dist, orig_reconstruction_dist, target_reconstruction_dist, _, _, _, _ = adv_test(orig_img, target_img, C=bestC, plot = True, iteration = iteration)
